...
public class InMemoryProcessServiceTest {

	@Rule
	public ExpectedException expected = ExpectedException.none();
	
	private InMemoryProcessService service;
	
	private Map<String, Map<String, Source>> repo;
	
	@Before
	public void setUp() {
		service = new InMemoryProcessService(creatRepoWith5ProjectsAnd5ProcessesEach());
	}

...
public class DummyProjectServiceTest {
  ...
  @Test
  public void itShouldReturnFalseIfProcessIDIsEmptyOrNull(){
    final DummyProjectService dummyProjectService = new DummyProjectService();
  ...
  @Test
  public void itShouldReturnAListWithAllProjectsIDInTheDB(){
    final DummyProjectService dummyProjectService = new DummyProjectService();
    final List<String> dummyProjectIDListTest = dummyProjectService.listAll();
  ...
  public void dummyProjectServiceShouldCreateAProjectReceivingAProjectTypeAndReturnTheID(){
    final DummyProjectService dummyProjectService = new DummyProjectService();
    final String projectIDTest = dummyProjectService.create(ProjectType.BPMN);
